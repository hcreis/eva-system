...
CREATE TABLE EXECUTION (
  ...
  PRIMARY KEY(EXECUTION_ID, STUDENT_ID, TEST_ID),
  INDEX EXECUTION_FKIndex1(STUDENT_ID),
  INDEX EXECUTION_FKIndex2(TEST_ID)
);

CREATE TABLE EXEC_INFORMATION (
  EXEC_INFORMATION_ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  EXECUTION_STUDENT_ID INTEGER UNSIGNED NOT NULL,
  ANSWARE_ID INTEGER UNSIGNED NOT NULL,
  QUESTION_ID INTEGER UNSIGNED NOT NULL,
  EXECUTION_ID INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY(EXEC_INFORMATION_ID),
  INDEX EXEC_INFORMATION_FKIndex1(EXECUTION_ID, EXECUTION_STUDENT_ID),
...
CREATE TABLE PART (
  ...
  SECTION_TEST_ID INTEGER UNSIGNED NOT NULL,
  SECTION_ID INTEGER UNSIGNED NOT NULL,
  PART_DIRECTION VARCHAR(255) NULL,
  PART_NAME VARCHAR(255) NULL,
  PART_NUMBER_QUESTIONS INTEGER UNSIGNED NULL,
  PRIMARY KEY(PART_ID, SECTION_TEST_ID, SECTION_ID),
  INDEX PART_FKIndex1(SECTION_ID, SECTION_TEST_ID)
);

CREATE TABLE QUESTION (
  QUESTION_ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  PART_SECTION_ID INTEGER UNSIGNED NOT NULL,
  PART_SECTION_TEST_ID INTEGER UNSIGNED NOT NULL,
  PART_ID INTEGER UNSIGNED NOT NULL,
  QUESTION_DESCRIPTION VARCHAR(255) NOT NULL,
  QUESTION_EXAMPLE BOOL NOT NULL,
  PRIMARY KEY(QUESTION_ID),
  INDEX QUESTION_FKIndex1(PART_ID, PART_SECTION_TEST_ID, PART_SECTION_ID)
);
...
CREATE TABLE STUDENT (
  ...
  INDEX STUDENT_FKIndex1(COURSE_ID),
  INDEX STUDENT_FKIndex2(ENGLISH_LEVEL_ELEVEL_ID)
);
